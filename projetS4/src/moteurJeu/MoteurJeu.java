...
public class MoteurJeu {
	...
	private boolean testUnitairesNonRegression = false;
	/**
	...
	public MoteurJeu(int numMap, String fichier){
		...
		//if (!testUnitairesNonRegression)jeu();
	}
	 ...
	 * @param listeRejoue Liste de deplacements
	 */
	public void rejouerPartie(List<Character> listeRejoue){
		deplacements=(ArrayList<Character>)listeRejoue;
		resetMap();
...
public IA_Random getIaRandom() {
	...
	public void setTestUnitairesNonRegression(boolean b) {
		// TODO Auto-generated method stub
		testUnitairesNonRegression = true ;
